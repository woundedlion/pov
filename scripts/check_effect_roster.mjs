// Cross-check that the HS_EFFECT_LIST X-macro roster in core/engine/effects.h matches
...
if (unlisted.length || unregistered.length) {
  if (unlisted.length)
    console.error(`::error::effects/*.h register effects absent from HS_EFFECT_LIST (add an #include + X() row in core/engine/effects.h): ${unlisted.join(', ')}`);
