...
#include <bit>
#include <limits>
// Generated by tools/generate_pullback_manifest_header.py; absent when the
// build found no Python interpreter (tests/CMakeLists.txt).
#ifndef HS_HAVE_PULLBACK_MANIFEST
#define HS_HAVE_PULLBACK_MANIFEST 1
#endif
...
inline void test_shader_workbench_preset_bank() {
  ...
  constexpr auto MOBIUS_GRID_EXPECTED = std::to_array<uint32_t>(
      {0,          1,          1,          4,          0,          0,
       0,          0,          0,          1,          1337,       7,
       0,          0,          0,          0,          1,          1337,
       1,          0,          1,          1,          2,          1,
...
inline void test_shader_workbench_prepared_hue_noise_color() {
  ...
  HS_EXPECT_LE(error.max, maximum.measured_baseline);
  HS_EXPECT_LE(error.mean(), static_cast<uint64_t>(mean.accepted_limit));
  HS_EXPECT_LE(error.mean(), mean.measured_baseline);
...
inline void test_shader_workbench_fast_peirce_square() {
  ...
  HS_EXPECT_LE(max_coordinate_error, coordinate.measured_baseline);
  HS_EXPECT_LE(max_edge_error, edge.accepted_limit);
  HS_EXPECT_LE(max_edge_error, edge.measured_baseline);
