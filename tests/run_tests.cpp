...
#define HS_TEST_MODULE_LIST(X)                                                 \
  ...
  X("shaderball", 51, hs_test::shaderball_tests::run_shaderball_tests,         \
    1045178)                                                                   \
  ...
  X("pov_sync", 49, hs_test::pov_sync_tests::run_pov_sync_tests, 2015)         \
  ...
  X("death", 146, hs_test::death_tests::run_death_tests, 259)
