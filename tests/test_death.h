...
inline const Case *all_cases(int &n) {
  static const Case
      cases
          [] =
              {
                  {"noise_hue_bake_invalid_scale",
                   case_noise_hue_bake_invalid_scale,
                  ...
                  {"star_mismatched_radius_cache",
                   case_star_mismatched_radius_cache,
                   "core/render/plot/shapes.h",
                   "(cache_matches) Star: cached trigonometry does not match inputs"},
                  {"star_mismatched_step_cache",
                   case_star_mismatched_step_cache, "core/render/plot/shapes.h",
                   "(cache_matches) Star: cached trigonometry does not match inputs"},
                  {"reaction_lattice_uninitialized",
                   case_reaction_lattice_uninitialized,
                   "effects/ReactionDiffusionBase.h",
                   "(nodes != nullptr) ReactionDiffusion: lattice is not initialized"},
                  {"recipe_bake_live_iterations",
                   case_recipe_bake_live_iterations, "core/mesh/recipe.h",
                   "(!step.bake || step.param == 0.0f) apply_step: a baked RELAX step must not specify live iterations"},
                  {"pullback_mobius_degenerate",
                   case_pullback_mobius_degenerate,
                  ...
                  {"ball_drop_nonfinite_azimuth",
                   case_ball_drop_nonfinite_azimuth, "core/animation/params.h",
       "(std::isfinite(azimuth)) BallDrop azimuth must be finite"},
                  ...
                  {"field_transfer_outside_range",
                   case_field_transfer_outside_range,
                  ...
                  {"field_sample_coverage_outside_range",
                   case_field_sample_coverage_outside_range,
                   "core/render/pullback/stage.h",
                  ...
                  {"arena_oom", case_arena_oom, "core/engine/memory.cpp",
                   "(false) Arena::allocate: out of memory"},
                  {"arena_make_oom", case_arena_make_oom,
                  ...
                  {"resplit_persistent_strands",
                   case_resplit_persistent_strands, "core/engine/memory.h",
                  ...
                  {"arena_vector_overflow", case_arena_vector_overflow,
                   ...
                   "capacity exceeded!"},
                  {"arena_vector_emplace_overflow",
                   case_arena_vector_emplace_overflow, "core/engine/memory.h",
                   "(element_count < element_capacity) ArenaVector emplace_back exact "
                   "capacity exceeded!"},
                  {"generate_target_is_scratch",
                   case_generate_target_is_scratch, "core/engine/memory.h",
                   "(&target != &scratch_arena_a && &target != &scratch_arena_b) "
                   "generate: target must not alias an engine scratch arena"},
                  {"generate_recursion_too_deep",
                   case_generate_recursion_too_deep, "core/engine/memory.h",
                  ...
                  {"rotate_plane_degenerate", case_rotate_plane_degenerate,
                   ...
                   "!= b) rotate_plane: "},
                  {"angle_between_zero", case_angle_between_zero,
                   "core/math/3dmath.h",
                  ...
                  {"circular_buffer_oob", case_circular_buffer_oob,
                   ...
                   "outside [0, 2)"},
                  {"circular_buffer_front_empty",
                   case_circular_buffer_front_empty,
                   "core/containers/static_circular_buffer.h",
                   "(!is_empty()) front() on empty StaticCircularBuffer"},
                  {"circular_buffer_back_empty",
                   case_circular_buffer_back_empty,
                   "core/containers/static_circular_buffer.h",
                  ...
                  {"reaction_graph_slot_out_of_range",
                   case_reaction_graph_slot_out_of_range,
                   "core/spatial/reaction_graph.h",
                  ...
                  {"timeline_handled_relocation",
                   case_timeline_handled_relocation,
                   "core/animation/timeline.h",
                  ...
                  {"transition_nonfinite_target",
                   case_transition_nonfinite_target, "core/animation/params.h",
                  ...
                  {"timeline_start_overflow", case_timeline_start_overflow,
                   ...
                   "overflow"},
                  {"timeline_handled_completion",
                   case_timeline_handled_completion,
                   "core/animation/timeline.h",
                  ...
                  {"timeline_pinned_one_shot_timer",
                   case_timeline_pinned_one_shot_timer,
                   "core/animation/timeline.h",
                   "(!e.handled || anim->is_canceled()) pinned animation completed; only "
                   "cancel() may destroy a pinned event"},
                  {"timeline_clear_pinned", case_timeline_clear_pinned,
                   ...
                   "animation"},
                  {"timeline_clear_during_step",
                   case_timeline_clear_during_step, "core/animation/timeline.h",
                   "(!stepping) clear() from inside step() would destroy the animation "
                   "whose callback is running"},
                  {"preset_choreography_no_slots",
                   case_preset_choreography_no_slots,
                  ...
                  {"timeline_clear_hook_adds_event",
                   case_timeline_clear_hook_adds_event,
                   "core/animation/timeline.h",
                  ...
                  {"segue_sprite_no_slot", case_segue_sprite_no_slot,
                   ...
                   "timeline slot"},
                  {"mesh_carousel_unflipped_slot",
                   case_mesh_carousel_unflipped_slot,
                  ...
                  {"transformer_pool_active_index_oob",
                   case_transformer_pool_active_index_oob,
                   "core/animation/transformer.h",
                  ...
                  {"transformer_pool_arena_reclaimed",
                   case_transformer_pool_arena_reclaimed,
                   "core/animation/transformer.h",
                  ...
                  {"particle_lifetime_nan", case_particle_lifetime_nan,
                   ...
                   "(std::isfinite(max_life) && max_life >= 1.0f && max_life <= "
                   "65535.0f) ParticleSystem max_life must be finite and in [1, 65535]"},
                  {"random_walk_nonfinite_options",
                   case_random_walk_nonfinite_options,
                  ...
                  {"particle_lifetime_over_max",
                   case_particle_lifetime_over_max, "core/animation/sprites.h",
                   "(std::isfinite(max_life) && max_life >= 1.0f && max_life <= "
                   "65535.0f) ParticleSystem max_life must be finite and in [1, 65535]"},
                  ...
                  {"correction_guard_cross_type",
                   case_correction_guard_cross_type, "core/platform/led.h",
                   "(!correction_guard_live()) at most one correction guard may be "
                   "live at a time (see contract above)"},
                  ...
                  {"zip_aliased_arenas", case_zip_aliased_arenas,
                   "core/mesh/conway.h",
                   "(&target != &temp) zip: target and temp must differ"},
                  {"gyro_aliased_arenas", case_gyro_aliased_arenas,
                   "core/mesh/conway.h",
                   "(&target != &temp) gyro: target and temp must differ"},
                  {"bevel_aliased_arenas", case_bevel_aliased_arenas,
                   "core/mesh/conway.h",
                   "(&target != &temp) bevel: target and temp must differ"},
                  {"ambo_aliased_arenas", case_ambo_aliased_arenas,
                   "core/mesh/conway.h",
                   "(&target != &temp) ambo: target and temp must differ"},
                  {"mesh_compile_aliased_arenas",
                   case_mesh_compile_aliased_arenas, "core/mesh/mesh.h",
                   "(&geom_arena != &scratch) MeshOps::compile geom_arena must not alias "
                   "scratch"},
                  {"mesh_ops_clone_aliases_dst",
                   case_mesh_ops_clone_aliases_dst, "core/mesh/mesh.h",
                   "(&src != &dst) MeshOps::clone src must not alias dst"},
                  {"mesh_state_clone_aliases_dst",
                   case_mesh_state_clone_aliases_dst, "core/mesh/mesh_state.h",
                   "(&src != &dst) MeshState::clone src must not alias "
                   "dst"},
                  {"mesh_transform_aliases_source",
                   case_mesh_transform_aliases_source, "core/mesh/conway.h",
                   "(&mesh != &transformed) MeshOps::transform source mesh must not alias "
                   "the destination"},
                  {"chamfer_collapsed_endpoint",
                   case_chamfer_collapsed_endpoint, "core/mesh/conway.h",
                  ...
                  {"conway_target_exhausted", case_conway_target_exhausted,
                   "core/engine/memory.cpp",
                   "(false) Arena::allocate: out of memory"},
                  {"relax_baked_dimension_mismatch",
                   case_relax_baked_dimension_mismatch, "core/mesh/conway.h",
                   "(V == bake.vertex_count && F == bake.face_count && I == "
                   "bake.index_count) relax_baked: source dimensions differ"},
                  {"relax_baked_topology_mismatch",
                   case_relax_baked_topology_mismatch, "core/mesh/conway.h",
                   "(relax_topology_hash(mesh) == bake.topology_hash) relax_baked: source "
                   "topology differs"},
                  {"relax_baked_source_mismatch",
                   case_relax_baked_source_mismatch, "core/mesh/relax_bake.h",
                  ...
                  {"half_edge_face_counts_short",
                   case_half_edge_face_counts_short, "core/mesh/mesh.h",
                   "(counted_indices == total_indices) mesh face counts do not span flat "
                   "index length"},
                  {"half_edge_face_counts_long",
                   case_half_edge_face_counts_long, "core/mesh/mesh.h",
                   "(count <= total_indices - counted_indices) mesh face counts exceed "
                   "flat index length"},
                  {"mesh_compile_face_counts_short",
                   case_mesh_compile_face_counts_short, "core/mesh/mesh.h",
                   "(counted_indices == total_indices) mesh face counts do not span flat "
                   "index length"},
                  {"mesh_compile_face_counts_long",
                   case_mesh_compile_face_counts_long, "core/mesh/mesh.h",
                   "(count <= total_indices - counted_indices) mesh face counts exceed "
                   "flat index length"},
                  {"mesh_compile_face_span_over_16bit",
                   ...
                   "16-bit index range"},
                  {"update_hankin_stale_topology",
                   case_update_hankin_stale_topology, "core/mesh/hankin.h",
                  ...
                  {"update_hankin_borrowed_stale_topology",
                   case_update_hankin_borrowed_stale_topology,
                   "core/mesh/hankin.h",
                   "(prior_topology_size == 0 || out_mesh.topology_key == "
                   "compiled.topology_key) update_hankin: reused out_mesh carries "
                   "a topology from a different compiled pattern (clear it first)"},
                  {"update_hankin_nonfinite_angle",
                   case_update_hankin_nonfinite_angle, "core/mesh/hankin.h",
                  ...
                  {"half_edge_non_manifold_edge",
                   case_half_edge_non_manifold_edge, "core/mesh/mesh.h",
                   "(j - i <= 2) non-manifold edge: >2 half-edges share an edge"},
                  {"half_edge_inconsistent_winding",
                   case_half_edge_inconsistent_winding, "core/mesh/mesh.h",
                  ...
                  {"mesh_narrow_face_count", case_mesh_narrow_face_count,
                   ...
                   "uint8_t range"},
                  {"mesh_require_closed_manifold",
                   case_mesh_require_closed_manifold, "core/mesh/mesh.h",
                   "(he_mesh.half_edges[i].pair != HE_NONE) MeshOps::death requires a "
                   "closed manifold (unpaired half-edge)"},
                  {"mesh_require_vertex_manifold",
                   case_mesh_require_vertex_manifold, "core/mesh/mesh.h",
                  ...
                  {"mesh_require_matching_half_edge_census",
                   case_mesh_require_matching_half_edge_census,
                   "core/mesh/mesh.h",
                  ...
                  {"mesh_require_matching_half_edge_loops",
                   case_mesh_require_matching_half_edge_loops,
                   "core/mesh/mesh.h",
                   "(head == faces[face_offset + (k + 1) % count]) "
                   "MeshOps::death: half-edge mesh loops different faces than the "
                   "source mesh"},
                  {"apply_step_hankin_no_angle",
                   case_apply_step_hankin_no_angle, "core/mesh/recipe.h",
                  ...
                  {"motion_empty_path_origin_sample",
                   case_motion_empty_path_origin_sample,
                   "core/animation/motion.h",
                  ...
                  {"hue_wobble_depth_out_of_range",
                   case_hue_wobble_depth_out_of_range,
                  ...
                  {"iridescent_weight_negative",
                   case_iridescent_weight_negative, "core/color/composition.h",
                  ...
                  {"noise_hue_palette_null_source",
                   case_noise_hue_palette_null_source,
                   "core/color/noise_hue_palette.h",
                  ...
                  {"noise_hue_palette_null_noise_lut",
                   case_noise_hue_palette_null_noise_lut,
                   "core/color/noise_hue_palette.h",
                  ...
                  {"baked_palette_clone_from_self",
                   case_baked_palette_clone_from_self,
                   "core/color/baked_palette.h",
                   "(&src != &table) BakedPaletteStorage::clone_from from itself"},
                  {"baked_palette_bake_blend_self",
                   case_baked_palette_bake_blend_self,
                   "core/color/baked_palette.h",
                  ...
                  {"register_param_default_outside_range", case_register_param_default_outside_range, "core/control/param_host.h", "(*ptr >= min && *ptr <= max) register_param: default *ptr outside [min,max] name=outside value_bits=40000000 min_bits=00000000 max_bits=3f800000"},
                  ...
                  {"register_enum_param_bound_inexact",
                   case_register_enum_param_bound_inexact,
                   "core/control/param_host.h",
                  ...
                  {"register_int_param_range", case_register_int_param_range,
                   ...
                   "integer type"},
                  {"register_int_param_max_inexact",
                   case_register_int_param_max_inexact,
                   "core/control/param_host.h",
                   "(bounds_exact) register_int_param: bounds must be exactly representable as float"},
                  {"register_int_param_min_inexact",
                   case_register_int_param_min_inexact,
                   "core/control/param_host.h",
                   "(bounds_exact) register_int_param: bounds must be exactly representable as float"},
                  ...
                  {"set_clip_mid_frame", case_set_clip_mid_frame,
                   "core/render/canvas.h",
                   "(!canvas_active) clip cannot change while a frame is active"},
                  {"output_envelope_out_of_range",
                   case_output_envelope_out_of_range, "core/render/canvas.h",
                  ...
                  {"arcs_overlap_start_out_of_range",
                   case_arcs_overlap_start_out_of_range, "core/render/clip.h",
                   "(s1 >= 0 && s1 < w && s2 >= 0 && s2 < w) "},
                  {"scan_clip_out_of_bounds", case_scan_clip_out_of_bounds,
                   ...
                   "LUT domain"},
                  {"scan_clip_rows_out_of_bounds",
                   case_scan_clip_rows_out_of_bounds,
                   "core/render/scan/shader.h",
                   "(cr.x_start >= 0 && cr.x_end <= W && cr.render_y_start() >= 0 && "
                   "cr.render_y_end() <= H) scan clip region outside the canvas and trig "
                   "LUT domain"},
                  ...
                  {"plot_window_multi_segment", case_plot_window_multi_segment,
                   ...
                   "polyline"},
                  {"scan_pipeline_not_prepared",
                   case_scan_pipeline_not_prepared, "core/render/scan/raster.h",
                   "(pipeline.prepared_for(canvas)) direct raster pipeline not prepared "
                   "for this canvas"},
                  {"pipeline_ref_erase_not_prepared",
                   case_pipeline_ref_erase_not_prepared,
                   "core/engine/concepts.h",
                   "(t.prepared_for(cv)) direct raster pipeline not prepared for this "
                   "canvas"},
                  {"scan_mesh_face_index_out_of_range",
                   case_scan_mesh_face_index_out_of_range,
                  ...
                  {"world_trails_lifetime_over_max",
                   case_world_trails_lifetime_over_max,
                   "core/render/filter/world_trails.h",
                  ...
                  {"raster_point_projection_pair_mismatch",
                   case_raster_point_projection_pair_mismatch,
                   "core/render/plot/raster.h",
                  ...
                  {"raster_point_projections_short",
                   case_raster_point_projections_short,
                   "core/render/plot/raster.h",
                   "(point_rows == nullptr || opts.point_projections.size() == len) hoisted "
                   "point projections need one entry per polyline point"},
                  {"spherical_field_ring_index_oob",
                   case_spherical_field_ring_index_oob,
                  ...
                  {"spherical_field_infill_over_domain",
                   case_spherical_field_infill_over_domain,
                   "core/math/spherical_field.h",
                  ...
                  {"gradient_stop_out_of_range",
                   case_gradient_stop_out_of_range,
                   "core/color/palette_sources.h",
                  ...
                  {"random_timer_inverted_range",
                   case_random_timer_inverted_range, "core/animation/timers.h",
                   "(min >= 0 && min <= max) RandomTimer: invalid frame range"},
                  {"dma_controller_wedged_overrun",
                   case_dma_controller_wedged_overrun, "tests/test_death.h",
                  ...
                  {"effect_registry_duplicate_name",
                   case_effect_registry_duplicate_name,
                  ...
                  {"effect_registry_duplicate_stable_id",
                   case_effect_registry_duplicate_stable_id,
                   "core/control/registry.h",
                  ...
                  {"polyhedral_kaleidoscope_no_converge",
                   case_polyhedral_kaleidoscope_no_converge,
                   "core/math/lenses.h",
                  ...
                  {"sdf_spherical_polygon_radius_over_hemisphere",
                   ...
                   "core/render/sdf/shapes.h",
                   "(radius <= 1.0f) SDF SphericalPolygon: radius exceeds unit sphere"},
                  {"sdf_flower_radius_over_hemisphere",
                   case_sdf_flower_radius_over_hemisphere,
                   "core/render/sdf/shapes.h",
                   "(radius <= 1.0f) SDF Flower: radius exceeds unit sphere"},
                  {"sdf_flower_zero_radius", case_sdf_flower_zero_radius,
                   "core/render/sdf/shapes.h",
                   "(radius > 0.0f) SDF Flower: radius must be positive"},
                  {"sdf_class_lut_too_few_vertices",
                   case_sdf_class_lut_too_few_vertices,
                   "core/render/sdf/face.h",
                   "(count >= 3) build_canonical_distance_lut requires at least 3 polygon "
                   "vertices"},
                  {"sdf_class_lut_grid_too_small",
                   case_sdf_class_lut_grid_too_small, "core/render/sdf/face.h",
                  ...
                  {"sdf_distorted_ring_null_shift",
                   case_sdf_distorted_ring_null_shift,
                   "core/render/sdf/rings.h",
                   "(sf) DistortedRing: shift_fn must be non-null"},
                  {"sdf_ring_radius_past_antipode",
                   case_sdf_ring_radius_past_antipode,
                   "core/render/sdf/rings.h",
                   "(radius >= 0.0f && radius <= 2.0f) Ring: radius outside [0, 2]"},
                  {"sdf_ring_negative_thickness",
                   case_sdf_ring_negative_thickness, "core/render/sdf/rings.h",
                   "(thickness >= 0.0f) Ring: negative stroke half-width"},
                  {"sdf_distorted_ring_radius_past_antipode",
                   case_sdf_distorted_ring_radius_past_antipode,
                   "core/render/sdf/rings.h",
                   "(radius >= 0.0f && radius <= 2.0f) DistortedRing: radius outside "
                   "[0, 2]"},
                  {"sdf_distorted_ring_negative_thickness",
                   case_sdf_distorted_ring_negative_thickness,
                   "core/render/sdf/rings.h",
                   "(thickness >= 0.0f) DistortedRing: negative stroke half-width"},
                  {"sdf_line_negative_thickness",
                   case_sdf_line_negative_thickness, "core/render/sdf/shapes.h",
                  ...
                  {"chain_table_rank_decreases",
                   case_chain_table_rank_decreases,
                   "core/render/pullback/interpreter.h",
                  ...
                  {"dreamballs_woven_owner_vertex_oob",
                   case_dreamballs_woven_owner_vertex_oob,
                   "effects/DreamBalls.h",
                   "(vertex < vertex_count) DreamBalls: woven edge start vertex "
                   "outside the owner table"},
                  {"dreamballs_woven_owner_edge_oob",
                   case_dreamballs_woven_owner_edge_oob, "effects/DreamBalls.h",
                   "(edge_index < edges.size()) DreamBalls: woven owner query edge index "
                   "out of range"},
                  {"raymarch_placement_solid_oob",
                   case_raymarch_placement_solid_oob, "effects/Raymarch.h",
                  ...
                  {"sdf_angular_repeat_nonunit_axis",
                   case_sdf_angular_repeat_nonunit_axis,
                   "core/render/sdf/csg.h",
                   "(fabsf(ax.length() - 1.0f) < 1e-3f) SDF CSG: repetition axis must be unit length"},
                  {"sdf_distorted_ring_zero_knots",
                   case_sdf_distorted_ring_zero_knots,
                   "core/render/sdf/rings.h",
                   "(kn != nullptr && n >= 1) DistortedRing: knot storage must be nonempty"},
                  {"sdf_twist_zero_major_radius",
                   case_sdf_twist_zero_major_radius, "core/render/sdf/volume.h",
                   "(R > 0.0f) SDF Volume: radius must be positive"},
                  {"pick_next_edge_unknown_node",
                   case_pick_next_edge_unknown_node, "core/mesh/conway_graph.h",
                  ...
                  {"opleg_incomplete_palette_handoff",
                   case_opleg_incomplete_palette_handoff,
                   "core/animation/opleg.h",
                   "(handoff.bank && handoff.prev_face_palette && handoff.prev_faces > 0) "
                   "OpLeg: incomplete palette handoff"},
                  {"opleg_edge_settle_mismatch",
                   case_opleg_edge_settle_mismatch, "core/animation/opleg.h",
                  ...
                  {"opleg_edge_sweep_incomplete_handoff",
                   case_opleg_edge_sweep_incomplete_handoff,
                   "core/animation/opleg.h",
                   "(handoff.bank && handoff.prev_face_palette && handoff.prev_faces > 0) "
                   "OpLeg: incomplete palette handoff"},
                  {"opleg_hankin_incomplete_handoff",
                   case_opleg_hankin_incomplete_handoff,
                   "core/animation/opleg.h",
                   "(handoff.bank && handoff.prev_face_palette && handoff.prev_faces > 0) "
                   "OpLeg: incomplete palette handoff"},
                  {"opleg_hankin_backward_theta",
                   case_opleg_hankin_backward_theta, "core/animation/opleg.h",
                  ...
                  {"opleg_relax_no_iterations", case_opleg_relax_no_iterations,
                   ...
                   "iteration count"},
                  {"opleg_relax_incomplete_handoff",
                   case_opleg_relax_incomplete_handoff,
                   "core/animation/opleg.h",
                   "(handoff.bank && handoff.prev_face_palette && handoff.prev_faces > 0) "
                   "OpLeg: incomplete palette handoff"},
                  {"opleg_medial_incomplete_handoff",
                   case_opleg_medial_incomplete_handoff,
                   "core/animation/opleg.h",
                   "(handoff.bank && handoff.prev_face_palette && handoff.prev_faces > 0) "
                   "OpLeg: incomplete palette handoff"},
                  {"opleg_reconcile_no_endpoints",
                   case_opleg_reconcile_no_endpoints, "core/animation/opleg.h",
                   "(spec.to_positions) OpLeg: reconcile leg carries no "
                   "endpoints"},
                  {"opleg_reconcile_incomplete_handoff",
                   case_opleg_reconcile_incomplete_handoff,
                   "core/animation/opleg.h",
                   "(handoff.bank && handoff.prev_face_palette && handoff.prev_faces > 0) "
                   "OpLeg: incomplete palette handoff"},
                  {"opleg_gated_swap_zero_gate_frames",
                   case_opleg_gated_swap_zero_gate_frames,
                   "core/animation/opleg.h",
                   "(spec.gate_frames >= 1) OpLeg needs a positive gate length"},
                  {"opleg_gated_swap_incomplete_handoff",
                   case_opleg_gated_swap_incomplete_handoff,
                   "core/animation/opleg.h",
                   "(handoff.bank && handoff.prev_face_palette && handoff.prev_faces > 0) "
                   "OpLeg: incomplete palette handoff"},
                  {"opleg_shading_face_out_of_range",
                   case_opleg_shading_face_out_of_range,
                   "core/animation/opleg.h",
                   "(face < faces) OpLeg::Shading: ramp face out of range"},
                  {"pullback_project_nonunit_direction",
                   case_pullback_project_nonunit_direction,
                   "core/render/pullback/stage.h",
...
inline constexpr GuardGapAllowance GUARD_GAP_ALLOW[] = {
    ...
    {"core/render/pullback/operator_model.h", 1},
