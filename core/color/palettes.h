...
// Procedural Palettes
static constexpr ProceduralPalette DARK_RAINBOW({0.367f, 0.367f, 0.367f},
                                               {0.500f, 0.500f, 0.500f},
                                               {1.000f, 1.000f, 1.000f},
                                               {0.000f, 0.330f, 0.670f});
static constexpr ProceduralPalette BLOOD_STREAM({0.169f, 0.169f, 0.169f},
                                               {0.313f, 0.313f, 0.313f},
                                               {0.231f, 0.231f, 0.231f},
                                               {0.036f, 0.366f, 0.706f});
static constexpr ProceduralPalette VINTAGE_SUNSET({0.256f, 0.256f, 0.256f},
                                                 {0.500f, 0.080f, 0.500f},
                                                 {0.277f, 0.277f, 0.277f},
                                                 {0.000f, 0.330f, 0.670f});
static constexpr ProceduralPalette RICH_SUNSET({0.309f, 0.500f, 0.500f},
...
static constexpr ProceduralPalette LATE_SUNSET({0.337f, 0.500f, 0.096f},
                                              {0.500f, 1.000f, 0.176f},
                                              {0.261f, 0.261f, 0.261f},
                                              {0.153f, 0.483f, 0.773f});
static constexpr ProceduralPalette MANGO_PEEL({0.500f, 0.500f, 0.500f},
                                             {0.500f, 0.080f, 0.500f},
                                             {0.431f, 0.431f, 0.431f},
                                             {0.566f, 0.896f, 0.236f});
static constexpr ProceduralPalette ICE_MELT({0.500f, 0.500f, 0.500f},
                                           {0.500f, 0.500f, 0.500f},
                                           {0.083f, 0.147f, 0.082f},
                                           {0.579f, 0.353f, 0.244f});
static constexpr ProceduralPalette LEMON_LIME({0.455f, 0.455f, 0.455f},
...
static constexpr ProceduralPalette FIRE_GLOW({0.000f, 0.000f, 0.000f},
                                            {0.560f, 0.560f, 0.560f},
                                            {0.216f, 0.346f, 0.174f},
                                            {0.756f, 0.542f, 0.279f});
static constexpr ProceduralPalette DARK_PRIMARY({0.500f, 0.500f, 0.500f},
                                               {0.500f, 0.610f, 0.500f},
                                               {0.746f, 0.347f, 0.000f},
                                               {0.187f, 0.417f, 0.670f});
static constexpr ProceduralPalette MAUVE_FADE({0.583f, 0.000f, 0.583f},
                                             {1.000f, 0.000f, 1.000f},
                                             {0.191f, 0.348f, 0.191f},
                                             {0.175f, 0.045f, 0.150f});
static constexpr ProceduralPalette LAVENDER_LAKE({0.473f, 0.473f, 0.473f},
                                                {0.500f, 0.500f, 0.500f},
                                                {0.364f, 0.124f, 0.528f},
                                                {0.142f, 0.378f, 0.876f});
static constexpr ProceduralPalette DESERT_ROSE({0.500f, 0.500f, 0.500f},
                                              {0.500f, 0.270f, 0.442f},
                                              {0.303f, 1.012f, 0.585f},
                                              {0.985f, 0.720f, 0.212f});
static constexpr ProceduralPalette BRUISED_MOSS({0.500f, 0.500f, 0.500f},
                                               {0.500f, 0.500f, 0.500f},
                                               {0.142f, 0.252f, 0.000f},
                                               {0.492f, 0.200f, 0.670f});
static constexpr ProceduralPalette BRUISED_BANANA({0.620f, 0.620f, 0.620f},
                                                 {0.742f, 0.742f, 0.742f},
                                                 {0.162f, 0.286f, 0.012f},
                                                 {0.235f, 0.205f, 0.688f});
static constexpr ProceduralPalette BRIGHT_SUNRISE({0.620f, 0.620f, 0.620f},
                                                 {0.742f, 0.742f, 0.742f},
                                                 {0.162f, 0.286f, 0.012f},
                                                 {0.090f, 0.205f, 0.688f});
static constexpr ProceduralPalette FIRE_AND_ICE({0.500f, 0.500f, 0.500f},
                                              {0.500f, 0.500f, 0.500f},
                                              {0.955f, 1.004f, 0.910f},
                                              {0.167f, 0.018f, 0.930f});
static constexpr ProceduralPalette PEACH_POP({1.000f, 0.144f, 0.175f},
