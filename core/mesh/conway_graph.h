...
inline constexpr EdgeSpec EDGES[] = {
    ...
    {TRUNCATED_CUBE, CUBOCTAHEDRON, CUBE, MorphOp::TRUNCATE,
     Solids::T_TRUNC_CUBE, 0.5f, 0.0f, 0.0f, false, Reseed::NONE, false},
    {CUBE, RHOMBICUBOCTAHEDRON, CUBE, MorphOp::EXPAND, 0.0f,
     MeshOps::EXPAND_DEFAULT_T, 0.0f, 0.0f, false, Reseed::NONE, false},
    {CUBE, SNUB_CUBE, CUBE, MorphOp::SNUB, 0.0f, Solids::T_SNUB_CUBE, 0.0f,
     Solids::SNUB_CUBE_TWIST, true, Reseed::NONE, false},
    {CUBOCTAHEDRON, TRUNCATED_CUBOCTAHEDRON, CUBOCTAHEDRON, MorphOp::TRUNCATE,
     0.0f, Solids::T_TRUNC_CUBE, 0.0f, 0.0f, true, Reseed::NONE, false},
    {OCTAHEDRON, TRUNCATED_OCTAHEDRON, OCTAHEDRON, MorphOp::TRUNCATE, 0.0f,
     Solids::T_TRUNC_THIRD, 0.0f, 0.0f, false, Reseed::NONE, false},
    {TRUNCATED_OCTAHEDRON, CUBOCTAHEDRON, OCTAHEDRON, MorphOp::TRUNCATE,
     Solids::T_TRUNC_THIRD, 0.5f, 0.0f, 0.0f, false, Reseed::NONE, false},
    ...
    {DODECAHEDRON, TRUNCATED_DODECAHEDRON, DODECAHEDRON, MorphOp::TRUNCATE,
     0.0f, Solids::T_TRUNC_ICOS, 0.0f, 0.0f, false, Reseed::NONE, false},
    ...
    {TRUNCATED_DODECAHEDRON, ICOSIDODECAHEDRON, DODECAHEDRON, MorphOp::TRUNCATE,
     Solids::T_TRUNC_ICOS, 0.5f, 0.0f, 0.0f, false, Reseed::NONE, false},
    ...
    {ICOSIDODECAHEDRON, TRUNCATED_ICOSIDODECAHEDRON, ICOSIDODECAHEDRON,
     MorphOp::TRUNCATE, 0.0f, Solids::T_TRUNC_ICOS, 0.0f, 0.0f, true,
     Reseed::NONE, false},
