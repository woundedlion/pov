...
// Gradient Palettes
static const Gradient rainbow({{0.0f / 16, CPixel(0xFF0000)},
...
static const Gradient rainbowStripes({{0.0f / 16, CPixel(0xFF0000)},
...
static const Gradient rainbowThinStripes(
    {{0.0f, CPixel(0xFF0000)},       {1.0f / 32, CPixel(0x000000)},
     {3.0f / 32, CPixel(0x000000)},  {4.0f / 32, CPixel(0xAB5500)},
     {5.0f / 32, CPixel(0x000000)},  {7.0f / 32, CPixel(0x000000)},
     {8.0f / 32, CPixel(0xABAB00)},  {9.0f / 32, CPixel(0x000000)},
     {11.0f / 32, CPixel(0x000000)}, {12.0f / 32, CPixel(0x00FF00)},
     {13.0f / 32, CPixel(0x000000)}, {15.0f / 32, CPixel(0x000000)},
     {16.0f / 32, CPixel(0x00AB55)}, {17.0f / 32, CPixel(0x000000)},
     {19.0f / 32, CPixel(0x000000)}, {20.0f / 32, CPixel(0x0000FF)},
     {21.0f / 32, CPixel(0x000000)}, {23.0f / 32, CPixel(0x000000)},
     {24.0f / 32, CPixel(0x5500AB)}, {25.0f / 32, CPixel(0x000000)},
     {27.0f / 32, CPixel(0x000000)}, {28.0f / 32, CPixel(0xAB0055)},
     {29.0f / 32, CPixel(0x000000)}, {32.0f / 32, CPixel(0x000000)}});

static const Gradient emeraldForest({{0.0f, CPixel(0x004E64)},
