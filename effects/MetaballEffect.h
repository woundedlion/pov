...
public:
    ...
    void draw_frame() override {
        ...
        for (int i = 0; i < balls.size(); i++) {
            ...
            float ny = noise.GetNoise(t * params.noise_speed, (float)i * 10.0f, 100.0f);
            float nz = noise.GetNoise(t * params.noise_speed, (float)i * 10.0f, 200.0f);
...
private:
    ...
    void init_balls() {
        balls.clear();
        balls.reserve((int)params.num_balls);
        for (int i = 0; i < (int)params.num_balls; ++i) {
