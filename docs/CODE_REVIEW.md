...
66. [Low] **Cross-cutting — pervasive essay-length comment blocks.** Flagged independently in nearly every scope; several rationale blocks dwarf and obscure the code they annotate, running against the repo's own terse-comment convention. Trim to fact-focused comments.
