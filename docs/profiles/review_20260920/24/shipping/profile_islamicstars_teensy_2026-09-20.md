# IslamicStars on-device profile — Teensy 4.0, segmented mode (2026-09-20, **selective -O3**) - experimental finding 24

Point-in-time snapshot of an **unlanded experimental correction (finding 24)**.
