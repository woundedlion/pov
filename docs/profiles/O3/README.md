...
| ● [RingSpin](profile_ringspin_teensy_2026-07-15.md) | 39.1 ms | **16 fps** (hard lock) | slim ring-group raster (`rs_ring_scan`) | 1.27× |
...
and RingSpin were re-captured 2026-07-15 at their fused-scan tips (RingSpin
again after the slim RingGroup rework, which hard-locks its -O3 16 fps and
lifts -Os to ~14 fps). The other rows carry their original 2026-07-14
captures. IslamicStars now has a full
