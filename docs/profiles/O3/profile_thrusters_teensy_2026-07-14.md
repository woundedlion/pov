...
`build/profile_thrusters_o3.log` (64-frame windows, ~75 s single pass). This is the **-O3** twin of the shipping `-Os` report (`../Os/profile_thrusters_teensy_2026-07-14.md`); the only variable is the optimization level. Re-captured 2026-07-14 **after the plot column-cull batch** (9ac8cebd, 62450701, 708d4b9b).
