...
2026-07-26 11:55 log that postdates this report: the index peak is the current
figure and the numbers below are the earlier capture. `just profile HankinSolids`
