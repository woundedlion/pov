# AlienBrain on-device profile — Teensy 4.0, segmented mode (2026-08-16, **selective -O3**)

Point-in-time snapshot (regenerate with `just profile AlienBrain`).
Raw capture: `build/prof/alienbrain_ship.log`.
...
| Effect | AlienBrain 288×144, single-entry playlist, tip `69d4751cc077` |
...
A display window is 62.5 ms. AlienBrain is a strobe effect rendering one
...
|---:|---|--:|--:|--:|--:|
| 4 | alien-brain-4 | 27.00 | 30.28 | 0/1,080 | 16 |
| 2 | alien-brain-2 | 26.98 | 30.61 | 0/1,409 | 16 |
| 1 | alien-brain | 26.93 | 30.47 | 0/1,080 | 16 |
| 0 | alien-brain (initial hold) | 26.87 | 31.95 | 0/119 | 16 |
| 3 | alien-brain-3 | 26.18 | 30.08 | 0/1,080 | 16 |
...
`HS_PROFILE_WINDOW=16`; `just profile AlienBrain` performs the locked build,
