...
|---|---|--:|--:|---|
| [ShaderBall](profile_shaderball_teensy_2026-08-15.md)§ ● | inverse pullback pipeline | 🟢 59.20 (13) | 🟢 0/2208 (0%) | 2026-08-15 16:35 |
...
ShaderBall spans the current 13-preset bank; all presets hold 16 fps. Preset 4
is the new shipping ceiling, while the optimized preset 11 is cadence-safe.
