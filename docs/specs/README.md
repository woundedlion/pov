...
|---|---|
| [pullback_pipeline_spec.md](pullback_pipeline_spec.md) | LANDED with superseded sections marked locally (§§2, 5.1, 8, 9.1, 9.3, 11, 14, 16) and stage-model qualifications in §§3, 5.2, 6. Describes the composition core, carriers, providers and operators under `core/render/pullback/`; the stage-families spec owns the shipped ranked-stage contract. §17 is deferred design with no implementation. |
